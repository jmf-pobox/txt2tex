...
\noindent Key insight: We extract p once, then use it in both cases
after splitting on $(q \lor r)$.
...
\noindent Key insight: Both cases yield the same conclusion p and $(q
\lor r)$, since
