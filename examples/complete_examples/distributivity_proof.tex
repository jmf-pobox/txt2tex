...
\noindent $(p \land (q \lor r))$ $\Leftrightarrow$ $((p \land q) \lor (p \land r))$
...
\noindent 1. Forward direction: $(p \land (q \lor r))$ $\Rightarrow$ $((p \land q) \lor (p \land r))$

\bigskip

\noindent 2. Backward direction: $((p \land q) \lor (p \land r))$ $\Rightarrow$ $(p \land (q \lor r))$
...
\noindent First, we prove the forward implication. Starting from p and $(q \lor r)$,

\bigskip

\noindent we extract p and $(q \lor r)$ separately, then case-analyze on $(q \lor r)$.
...
\noindent Key insight: We extract p once, then use it in both cases after splitting on $(q \lor r)$.
...
\noindent For the backward direction, we start with $(p \land q)$ or $(p \land r)$ and
...
\noindent Key insight: Both cases yield the same conclusion p and $(q \lor r)$, since
...
\noindent - $(p \land (q \lor r))$ $\Rightarrow$ $((p \land q) \lor (p \land r))$

\bigskip

\noindent - $((p \land q) \lor (p \land r))$ $\Rightarrow$ $(p \land (q \lor r))$
...
\noindent We can combine them $using \Leftrightarrow introduction$ to conclude:
...
\noindent 1. **Bidirectional proof structure**: Equivalences require proving both directions
...
\noindent 4. **Proof symmetry**: Both directions use similar patterns but different orders

\bigskip

\noindent 5. **Combining inference rules**: Multiple rules work together naturally
...
\noindent The distributive law is fundamental in logic and appears frequently in:
...
\noindent This proof will use similar techniques but with the roles of and/or reversed.
