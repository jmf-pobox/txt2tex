  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \implies ((p \land q) \lor (p \land r))}{
      ...
      \infer[\lor\textrm{-elim}^{[2]}]{(p \land q) \lor (p \land r)}{
        ...
        &
        \raiseproof{10ex}{\infer[\lor \mbox{intro}]{(p \land q) \lor
          (p \land r)}{\infer[\land \mbox{intro}]{p \land q}{
        ...
        \hskip 6em \raiseproof{26ex}{\infer[\lor \mbox{intro}]{(p
          \land q) \lor (p \land r)}{\infer[\land \mbox{intro}]{p \land r}{
              \infer[\land\textrm{-elim}^{[1]}]{p}{}
              &
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \land r)) \implies (p \land (q \lor r))}{
      ...
      \infer[\lor\textrm{-elim}^{[4]}]{p \land (q \lor r)}{
        ...
        &
        \raiseproof{8ex}{\infer[\land \mbox{intro}]{p \land (q \lor
          r)}{\infer[\land \mbox{elim}]{p}{} & \infer[\lor
        \mbox{intro}]{q \lor r}{}}}
        &
        \hskip 6em \raiseproof{22ex}{\infer[\land \mbox{intro}]{p
          \land (q \lor r)}{\infer[\land \mbox{elim}]{p}{} &
        \infer[\lor \mbox{intro}]{q \lor r}{}}}
      }
    }
    $%
  }
