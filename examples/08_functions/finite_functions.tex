...
\addcontentsline{toc}{section}{Phase 34: Finite Partial Functions}
...
\subsection*{Example 1 : Basic Finite Function Type}
\addcontentsline{toc}{subsection}{Example 1 : Basic Finite Function Type}
...
\noindent The records relation is a finite partial function because: 1. It is partial: not all years need to have a table 2. Its domain is finite: at most 1000 years have records 3. It is functional: each year maps to at most one table

\bigskip

\subsection*{Example 2 : Comparison with Other Function Types}
\addcontentsline{toc}{subsection}{Example 2 : Comparison with Other Function Types}

\noindent Comparison of function type operators:

\bigskip

\noindent - Total function ($\fun$): defined for all inputs, domain is entire source set - Partial function ($\pfun$): may not be defined for all inputs, domain may be infinite - Finite partial function ($\ffun$): partial function with finite domain - Total bijection ($\bij$): defined everywhere, injective and surjective
...
\subsection*{Example 3 : Finite Functions elem Practice}
\addcontentsline{toc}{subsection}{Example 3 : Finite Functions elem Practice}
...
\noindent This models a preference database where: - Not all customers have preferences recorded (partial) - The database has a capacity limit (finite domain) - Each customer maps to one preference value (functional)

\bigskip

\subsection*{Example 4 : Operations on Finite Functions}
\addcontentsline{toc}{subsection}{Example 4 : Operations on Finite Functions}
...
f\_composed : \nat \ffun \nat
\where
f\_composed = g \comp f \land \# (\dom f\_composed) \leq \# (\dom f)
\end{axdef}
...
\subsection*{Example 5 : Domain Restrictions land Finiteness}
\addcontentsline{toc}{subsection}{Example 5 : Domain Restrictions land Finiteness}
