...
g : \nat \ffun \nat
\where
f = \{1 \mapsto 10, 2 \mapsto 20, 3 \mapsto 30\} \land g = \{10 \mapsto 100, 20 \mapsto 200\} \land \# (\dom f) = 3 \land \# (\dom g) = 2
\end{axdef}
...
\where
recentSet = \{~ t : Title | t \in \dom viewed ~\} \land recent\_viewed = recentSet \dres viewed \land \# (\dom recent\_viewed) \leq \# (\dom viewed)
\end{axdef}
