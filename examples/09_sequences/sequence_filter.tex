...
\begin{axdef}
  ...
  filtered1 : \seq~\nat
  \where
  (s1 = \langle 1, 2, 3, 4, 5, 6 \rangle) \land (evens1 = \{2, 4, 6,
  8\}) \land (filtered1 = (s1 \filter evens1))
\end{axdef}
...
\begin{axdef}
  ...
  (filtered\_seq3 = s3 \filter A3) \land (restricted\_rel3 = R3 \rres
  \{10, 20\})
\end{axdef}
...
\begin{axdef}
  ...
  combined : \bag~\nat
  \where
  (b1 = \lbag 1, 1, 2, 3 \rbag) \land (b2 = \lbag 2, 3, 3, 4 \rbag)
  \land (combined = b1 \uplus b2)
\end{axdef}
