...
\addcontentsline{toc}{section}{User-Defined Squash Function}
...
\subsection*{Example 1 : Axiomatic Definition of Squash}
\addcontentsline{toc}{subsection}{Example 1 : Axiomatic Definition of Squash}
...
\subsection*{Example 2 : Using Squash on a Simple Function}
\addcontentsline{toc}{subsection}{Example 2 : Using Squash on a Simple Function}
...
\subsection*{Example 3 : Squash with Letters}
\addcontentsline{toc}{subsection}{Example 3 : Squash with Letters}
...
\subsection*{Example 4 : Empty Function}
\addcontentsline{toc}{subsection}{Example 4 : Empty Function}
...
\subsection*{Example 5 : Continuous Function ( No Gaps )}
\addcontentsline{toc}{subsection}{Example 5 : Continuous Function ( No Gaps )}
...
\noindent When the function has no gaps ($\dom f4 = 1 \upto 3$), squashFunc simply converts it to a sequence: s4 = $\langle 100, 200, 300 \rangle$.

\bigskip

\subsection*{Example 6 : Relationship Between Function land Sequence}
\addcontentsline{toc}{subsection}{Example 6 : Relationship Between Function land Sequence}
...
\subsection*{Example 7 : Squash Preserves Injectivity}
\addcontentsline{toc}{subsection}{Example 7 : Squash Preserves Injectivity}
...
\subsection*{Example 8 : Practical Use Case - Video Database}
\addcontentsline{toc}{subsection}{Example 8 : Practical Use Case - Video Database}
