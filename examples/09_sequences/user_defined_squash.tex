...
\begin{axdef}
  ...
  \where
  \forall f \colon \mathbb{N}_1(pfun)(X) \bullet \ran squash(f) =
  \ran f \land \# squash(f) = \# \ran f
\end{axdef}

\bigskip

This definition states that squash preserves the range and has length
equal to the cardinality of the range. The function compacts the
partial function into a sequence by removing gaps while maintaining
relative order.
