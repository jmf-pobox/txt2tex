...
\section*{Example 2 : Head land Tail}
\addcontentsline{toc}{section}{Example 2 : Head land Tail}
...
\section*{Example 3 : Last land Front}
\addcontentsline{toc}{section}{Example 3 : Last land Front}
