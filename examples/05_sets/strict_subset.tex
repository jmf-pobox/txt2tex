...
\noindent The strict subset operator (psubset, ⊂) represents proper subset relationships, where A is a subset of B AND A is not equal to B.
...
\section*{Example 2 : Comparing subset and psubset}
\addcontentsline{toc}{section}{Example 2 : Comparing subset and psubset}
...
\noindent X subset W is true (X is a subset of W, including the case where $X = W$)
