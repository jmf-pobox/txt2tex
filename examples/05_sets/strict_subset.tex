...
\noindent Here A psubset B holds because all elements of A $are \in
B$, and A contains fewer elements than B.
...
\noindent If A psubset B and B psubset C, then A psubset C.
