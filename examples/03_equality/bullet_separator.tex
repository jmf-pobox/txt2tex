...
\section*{Example 3 : Comparing With land Without Bullet}
\addcontentsline{toc}{section}{Example 3 : Comparing With land Without Bullet}
...
\addcontentsline{toc}{section}{Example 8 : Quantifiers with Bullet ( Limited Support )}
