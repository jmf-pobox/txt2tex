...
\section*{Example 3 : Finding and Doubling}
\addcontentsline{toc}{section}{Example 3 : Finding and Doubling}
...
\section*{Example 4 : Square Root and Square Again}
\addcontentsline{toc}{section}{Example 4 : Square Root and Square Again}
...
\where
\forall s : String @ \forall c : Char @ findAndAdvance(s, c) = (\mu i : \nat | charAt(s, i) = c) + 1
\end{axdef}
...
\section*{Example 11 : Comparison - With and Without Bullet}
\addcontentsline{toc}{section}{Example 11 : Comparison - With and Without Bullet}
...
\noindent The pattern "$(\mu x : T | uniqueness\_constraint)$. expression" is useful when:
