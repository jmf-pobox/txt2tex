...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{((p \lor q) \land (r \lor s)) \implies (p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{
  \infer[\lor \mbox{elim on p} \lor q]{(p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{\infer[\lor \mbox{elim on r} \lor s]{((p \land r))(or(p \land s))(or(q \land r))(or(q \land s))}{
...
} & \infer[\lor \mbox{elim on r} \lor s]{((p \land r))(or(p \land s))(or(q \land r))(or(q \land s))}{
...
\addcontentsline{toc}{section}{Example 3 : Proof by Mathematical Induction ( Base and Step )}
