...
\addcontentsline{toc}{section}{Advanced Proof Patterns}

\subsection*{Example 1 : Proof by Cases ( Three - Way Split )}
\addcontentsline{toc}{subsection}{Example 1 : Proof by Cases ( Three - Way Split )}

\noindent Prove: For all integers n, $n < 0 \lor n = 0 \lor n > 0$
...
\subsection*{Example 2 : Multi - Level Case Analysis}
\addcontentsline{toc}{subsection}{Example 2 : Multi - Level Case Analysis}

\noindent Prove: $(p \lor q) \land (r \lor s) \implies (p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)$
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{((p \lor q) \land (r \lor s)) \implies (p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{
  ...
  \raiseproof{10ex}{\infer[\lor\textrm{-intro}]{(p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{\infer[\land\textrm{-intro}]{p \land r}{}}}
&
\hskip 6em \raiseproof{26ex}{\infer[\lor\textrm{-intro}]{(p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{\infer[\land\textrm{-intro}]{p \land s}{}}}
} & \infer[\lor \mbox{elim on r} \lor s]{(p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{
  \raiseproof{10ex}{\infer[\lor\textrm{-intro}]{(p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{\infer[\land\textrm{-intro}]{q \land r}{}}}
&
\hskip 6em \raiseproof{26ex}{\infer[\lor\textrm{-intro}]{(p \land r) \lor (p \land s) \lor (q \land r) \lor (q \land s)}{\infer[\land\textrm{-intro}]{q \land s}{}}}
}}
}
$%
}
...
\subsection*{Example 3 : Proof by Mathematical Induction ( Base and Step )}
\addcontentsline{toc}{subsection}{Example 3 : Proof by Mathematical Induction ( Base and Step )}

\noindent Prove: For all $n \in \nat$, sum(1 to n) = n(n+1)/2
...
\subsection*{Example 4 : Structural Induction on Lists}
\addcontentsline{toc}{subsection}{Example 4 : Structural Induction on Lists}
...
\subsection*{Example 5 : Constructive Existence Proof}
\addcontentsline{toc}{subsection}{Example 5 : Constructive Existence Proof}
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{true \implies (\exists n : \nat @ even(n) \land n > 10)}{
  \infer[\exists \mbox{intro with n}=12]{\exists n : \nat @ even(n) \land n > 10}{\infer[\land\textrm{-intro}]{even(12) \land 12 > 10}{\infer[\mbox{arithmetic}]{12 > 10}{\infer[\mbox{definition of even}, 12=2 * 6]{even(12)}{\infer[\mbox{arithmetic}]{12 = 2 * 6}{\ulcorner true \urcorner^{[1]}}}}}}
}
$%
}
\end{center}
...
\subsection*{Example 6 : Non - Constructive Existence Proof}
\addcontentsline{toc}{subsection}{Example 6 : Non - Constructive Existence Proof}

\noindent Prove: There exist irrational numbers a and b such that a\textasciicircum{}b is rational
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{irrational(sqrt(2)) \implies (\exists a, b @ irrational(a) \land irrational(b) \land rational(power(a, b)))}{
  \infer[\lor\textrm{-elim}]{\exists a, b @ irrational(a) \land irrational(b) \land rational(power(a, b))}{\infer[\exists \mbox{intro with a}=b=sqrt(2)]{\exists a, b @ irrational(a) \land irrational(b) \land rational(power(a, b))}{\infer[\land\textrm{-intro}]{irrational(sqrt(2)) \land irrational(sqrt(2)) \land rational(power(sqrt(2), sqrt(2)))}{}} & \infer[\exists\textrm{-intro}]{\exists a, b @ irrational(a) \land irrational(b) \land rational(power(a, b))}{\infer[\land\textrm{-intro}]{irrational(power(sqrt(2), sqrt(2))) \land irrational(sqrt(2)) \land rational(power(power(sqrt(2), sqrt(2)), sqrt(2)))}{\infer[\mbox{known}]{rational(2)}{\infer[\mbox{simplification}]{power(sqrt(2), 2) = 2}{\infer[\mbox{arithmetic}]{power(sqrt(2), sqrt(2) * sqrt(2)) = power(sqrt(2), 2)}{\infer[\mbox{exponent law}]{power(power(sqrt(2), sqrt(2)), sqrt(2)) = power(sqrt(2), sqrt(2) * sqrt(2))}{}}}}}}}
}
$%
}
\end{center}
...
\subsection*{Example 7 : Proof by Strong Induction}
\addcontentsline{toc}{subsection}{Example 7 : Proof by Strong Induction}

\noindent Prove: Every natural number $n \geq 2$ has a prime factorization
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{(n \geq 2) \implies prime\_factorization(n)}{
  \infer[\lor\textrm{-elim}]{prime\_factorization(n)}{\infer[\mbox{trivial}, \mbox{singleton factorization}]{prime\_factorization(n)}{} & \infer[n=a * b]{prime\_factorization(n)}{\infer[\mbox{multiplication of factorizations}]{prime\_factorization(a * b)}{\infer[\mbox{strong IH}, b < n]{prime\_factorization(b)}{\infer[\mbox{strong IH}, a < n]{prime\_factorization(a)}{\infer[\mbox{definition of composite}]{\exists a, b @ 2 \leq a \land a < n \land 2 \leq b \land b < n \land n = a * b}{}}}}}}
}
$%
}
\end{center}
...
\subsection*{Example 8 : Proof Using Lemmas}
\addcontentsline{toc}{subsection}{Example 8 : Proof Using Lemmas}

\noindent Lemma 1: If n is even, then n\textasciicircum{}2 is even
...
\noindent Main theorem: If n\textasciicircum{}2 is odd, then n is odd
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{odd(power(n, 2)) \implies odd(n)}{
  \infer[\lor\textrm{-elim}]{odd(n)}{\infer[false\textrm{-elim}]{odd(n)}{\infer[\mbox{contradiction}]{false}{\infer[\mbox{contradiction}]{odd(power(n, 2)) \land even(power(n, 2))}{\infer[Lemma 1]{even(power(n, 2))}{}}}} & \infer[\mbox{identity}]{odd(n)}{}}
}
$%
}
\end{center}
...
\subsection*{Example 9 : Proof by Minimal Counterexample}
\addcontentsline{toc}{subsection}{Example 9 : Proof by Minimal Counterexample}

\noindent Prove: All natural numbers $n \geq 1$ satisfy $p(n)$
...
\adjustbox{max width=\textwidth}{%
$\displaystyle
\infer[\Rightarrow\textrm{-intro}^{[1]}]{true \implies (\forall n @ n \geq 1 \implies p(n))}{
  \infer[\lnot\textrm{-intro}^{[2]}]{\forall n @ n \geq 1 \implies p(n)}{\infer[\lor\textrm{-elim}]{false}{\infer[\mbox{contradiction}]{false}{\infer[\mbox{contradiction}]{\lnot ((p(m))) \land p(1)}{\infer[\mbox{base \mbox{case} \mbox{proved} separately}]{p(1)}{}}} & \infer[\mbox{contradiction}]{false}{\infer[\mbox{contradiction}]{\lnot ((p(m))) \land p(m)}{\infer[\mbox{by \mbox{inductive} \mbox{step} \mbox{from} p}(m - 1)]{p(m)}{\infer[\mbox{since m} - 1 >= 1 \land m - 1 < m]{p(m - 1)}{\infer[\mbox{minimality of m}]{\forall k @ k \geq 1 \land k < m \implies p(k)}{}}}}}}}
}
$%
}
\end{center}
...
\subsection*{Example 10 : Proof by Invariant}
\addcontentsline{toc}{subsection}{Example 10 : Proof by Invariant}
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{loop\_terminates \implies desired\_property}{
  \infer[\mbox{logic}]{desired\_property}{\infer[\land\textrm{-intro}]{invariant(termination\_state) \land termination\_condition}{\infer[\mbox{by preservation}]{invariant(termination\_state)}{\ulcorner loop\_terminates \urcorner^{[1]}}}}
}
$%
}
\end{center}
...
\subsection*{Example 11 : Proof by Diagonalization}
\addcontentsline{toc}{subsection}{Example 11 : Proof by Diagonalization}
...
\subsection*{Example 12 : Constructive Proof Pattern}
\addcontentsline{toc}{subsection}{Example 12 : Constructive Proof Pattern}

\noindent To constructively prove: $\exists x @ p(x)$

\bigskip

\noindent Strategy: 1. Explicitly construct a witness w 2. Verify $p(w)$ holds 3. Conclude $\exists x @ p(x)$ with $x = w$

\bigskip

\noindent Example: Prove $\exists n : \nat @ n > 100 \land even(n)$
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{true \implies (\exists n @ n > 100 \land even(n))}{
  \infer[\exists \mbox{intro with n}=102]{\exists n @ n > 100 \land even(n)}{\infer[\land\textrm{-intro}]{102 > 100 \land even(102)}{\infer[\mbox{definition}]{even(102)}{\infer[\mbox{arithmetic}]{102 = 2 * 51}{\infer[\mbox{arithmetic}]{102 > 100}{\infer[\mbox{construction}]{witness\_construction(102)}{\ulcorner true \urcorner^{[1]}}}}}}}
}
$%
}
\end{center}
...
\subsection*{Example 13 : Proof Composition}
\addcontentsline{toc}{subsection}{Example 13 : Proof Composition}
...
\adjustbox{max width=\textwidth}{%
$\displaystyle
\infer[\Rightarrow\textrm{-intro}^{[1]}]{true \implies (\forall n @ p(n))}{
  \infer[\lor \mbox{elim over cases}]{\forall n @ p(n)}{\infer[\mbox{direct proof}]{p(base)}{} & \infer[\lor \mbox{elim over subcases}]{p(n)}{
  \raiseproof{12ex}{\infer[\lnot\textrm{-intro}^{[2]}]{p(n)}{
  \infer[\mbox{contradiction}]{false}{\infer[\mbox{proof steps}]{contradiction\_derived}{\ulcorner \lnot ((p(n))) \urcorner^{[2]}}}
}}
&
\hskip 6em \raiseproof{30ex}{\infer[\Rightarrow\textrm{-intro}^{[3]}]{p(n)}{
  \infer[\mbox{inductive step}]{p(n)}{\ulcorner p(n - 1) \urcorner^{[3]}}
}}
}}
}
$%
...
\subsection*{Example 14 : Best Practices for Complex Proofs}
\addcontentsline{toc}{subsection}{Example 14 : Best Practices for Complex Proofs}

\noindent Guidelines for writing advanced proofs:

\bigskip

\noindent 1. State strategy at the beginning 2. Label cases clearly 3. Discharge assumptions promptly 4. Reference lemmas explicitly 5. Show key algebraic steps 6. Justify non-obvious steps 7. Use proof by cases when structure suggests it 8. Use induction for recursive definitions 9. Use contradiction for negative conclusions 10. Verify base cases thoroughly

\bigskip

\subsection*{Example 15 : Proof Documentation}
\addcontentsline{toc}{subsection}{Example 15 : Proof Documentation}

\noindent Document complex proofs:

\bigskip

\noindent - **Goal**: State what you're proving - **Strategy**: Explain the proof approach - **Lemmas needed**: List dependencies - **Key insights**: Highlight non-obvious steps - **Pitfalls**: Note where proof could go wrong - **Generalization**: Explain how proof extends
