...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mathrm{elim}]{p}{
      ...
      elim}]{p}{\infer[\mathrm{contradiction with} \lnot \lnot p]{false}{}}}
    }
    $%
  }
\end{center}
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mathrm{elim}]{\lnot p \lor \lnot q}{
      \infer[\lor \mathrm{elim}]{\lnot p \lor \lnot q}{\infer[\lor
        \mathrm{intro left}]{\lnot p \lor \lnot
      q}{\infer[\mathrm{identity}]{\lnot p}{}}}
    }
    $%
  }
\end{center}
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mathrm{elim}]{p}{
      \infer[\lor \mathrm{elim}]{p}{\infer[\mathrm{false
      elim}]{p}{\infer[\Rightarrow \mathrm{elim}]{false}{}}}
    }
    $%
  }
\end{center}
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{p \implies q}{
      \infer[\mathrm{assumption}]{p}{\infer[\mathrm{false
        elim}]{q}{\infer[\mathrm{contradiction}]{false}{}} &
        \infer[\mathrm{identity}]{q}{} & \infer[\lor
      \mathrm{elim}]{q}{\ulcorner \lnot p \lor q \urcorner^{[1]}}}
    }
    $%
  }
\end{center}
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mathrm{elim}]{p}{
      \infer[\lor \mathrm{elim}]{p}{\infer[\Rightarrow \mathrm{elim
        with premise}]{p}{\infer[\Rightarrow\textrm{-intro}^{[2]}]{p
          \implies q}{\infer[\mathrm{false
            elim}]{q}{\infer[\mathrm{contradiction}]{false}{\ulcorner p
      \urcorner^{[2]}}}}}}
    }
    $%
  }
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    (\forall y @ y(drinks))}{
      ...
      (\forall y @ y(drinks))}{\infer[\exists \mathrm{intro with
        ...
        y(drinks))}{\infer[\Rightarrow \mathrm{intro},
          \mathrm{trivially true}]{a(drinks) \implies (\forall y @
        ...
        y(drinks))}{\infer[\Rightarrow\textrm{-intro}^{[2]}]{b(drinks)
          ...
          y(drinks))}{\infer[\mathrm{assumption}]{b(drinks)}{\infer[\exists
              \mathrm{elim}]{\lnot (b(drinks))}{\infer[\mathrm{negation of}
