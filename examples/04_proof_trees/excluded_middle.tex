...
$\displaystyle
\infer[\lor \mbox{elim}]{q}{
  \infer[\mbox{assumption}]{\lnot p \implies q}{\infer[LEM]{p \lor \lnot p}{\ulcorner p \implies q \urcorner^{[1]}} & \infer[\Rightarrow \mbox{elim with p}\Rightarrow q]{q}{} & \infer[\Rightarrow \mbox{elim with} \lnot p\Rightarrow q]{q}{} & \infer[\lor \mbox{elim}]{q}{\ulcorner p \implies q \urcorner^{[1]}}}
}
$%
}
\end{center}
...
\adjustbox{max width=\textwidth}{%
$\displaystyle
\infer[\lor \mbox{elim}]{p}{
  \infer[\lor \mbox{elim}]{p}{\infer[\mbox{false elim}]{p}{\infer[\mbox{contradiction with} \lnot \lnot p]{false}{}}}
}
$%
}
\end{center}
...
\adjustbox{max width=\textwidth}{%
$\displaystyle
\infer[\lor \mbox{elim}]{\lnot p \lor \lnot q}{
  \infer[\lor \mbox{elim}]{\lnot p \lor \lnot q}{\infer[\lor \mbox{intro left}]{\lnot p \lor \lnot q}{\infer[\mbox{identity}]{\lnot p}{}}}
}
$%
}
\end{center}
...
$\displaystyle
\infer[\lor \mbox{elim}]{p}{
  \infer[\lor \mbox{elim}]{p}{\infer[\mbox{false elim}]{p}{\infer[\Rightarrow \mbox{elim}]{false}{}}}
}
$%
}
\end{center}
...
\adjustbox{max width=\textwidth}{%
$\displaystyle
\infer[\lor \mbox{elim}]{\lnot p \lor q}{
  \infer[\lor \mbox{elim}]{\lnot p \lor q}{\infer[\lor \mbox{intro left}]{\lnot p \lor q}{}}
}
$%
}
\end{center}
...
\infer[\Rightarrow\textrm{-intro}^{[1]}]{p \implies q}{
  \infer[\mbox{assumption}]{p}{\infer[\mbox{false elim}]{q}{\infer[\mbox{contradiction}]{false}{}} & \infer[\mbox{identity}]{q}{} & \infer[\lor \mbox{elim}]{q}{\ulcorner \lnot p \lor q \urcorner^{[1]}}}
}
$%
}
\end{center}
...
$\displaystyle
\infer[\lor \mbox{elim}]{p}{
  \infer[\lor \mbox{elim}]{p}{\infer[\Rightarrow \mbox{elim with premise}]{p}{\infer[\Rightarrow\textrm{-intro}^{[2]}]{p \implies q}{\infer[\mbox{false elim}]{q}{\infer[\mbox{contradiction}]{false}{\ulcorner p \urcorner^{[2]}}}}}}
}
$%
}
\end{center}
...
\noindent Constructive: To prove p or not p, you must either:
...
\noindent - Construct a proof of not p (a proof that p leads to contradiction)
...
\noindent 1. Assume not p [assumption 1]
...
\noindent 3. Conclude $\lnot$ $\lnot p$ [$\lnot$ intro from 1]

\bigskip

\noindent 4. Apply $LEM : p$ $\lor$ $\lnot p$
...
\noindent 6. [case] $\lnot p$ contradicts $\lnot$ $\lnot p$, derive p by false elim
...
\adjustbox{max width=\textwidth}{%
$\displaystyle
\infer[\lor \mbox{elim}]{\exists x @ x(drinks) \implies (\forall y @ y(drinks))}{
  \infer[\lor \mbox{elim}]{\exists x @ x(drinks) \implies (\forall y @ y(drinks))}{\infer[\exists \mbox{intro with x}=a]{\exists x @ x(drinks) \implies (\forall y @ y(drinks))}{\infer[\Rightarrow \mbox{intro}, \mbox{trivially true}]{a(drinks) \implies (\forall y @ y(drinks))}{\infer[\mbox{from p}]{\forall y @ y(drinks)}{\infer[\mbox{from p}]{a(drinks)}{\infer{Pick(any)(person)}{
  a
}}}}} & \infer[\exists \mbox{intro with x}=b]{\exists x @ x(drinks) \implies (\forall y @ y(drinks))}{\infer[\Rightarrow\textrm{-intro}^{[2]}]{b(drinks) \implies (\forall y @ y(drinks))}{\infer[\mbox{assumption}]{b(drinks)}{\infer[\exists \mbox{elim}]{\lnot (b(drinks))}{\infer[\mbox{negation of} \forall]{\exists b @ \lnot (b(drinks))}{}}}}}}
}
$%
}
\end{center}
...
\noindent 1. You need to prove something by case analysis on an arbitrary proposition

\bigskip

\noindent 2. You're working in classical logic (not constructive)
...
\noindent 4. Your proof strategy requires considering both p $\land$ $\lnot p$
...
\noindent - Law of excluded $middle : p$ $\lor$ $\lnot p$

\bigskip

\noindent - Double negation elimination: $\lnot$ $\lnot p \implies p$
