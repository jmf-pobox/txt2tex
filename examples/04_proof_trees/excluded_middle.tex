...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mbox{elim}]{q}{
      \infer[\mbox{assumption}]{\lnot p \implies q}{\infer[LEM]{p
        \lor \lnot p}{\ulcorner p \implies q \urcorner^{[1]}} &
        \infer[\Rightarrow \mbox{elim with p}\Rightarrow q]{q}{} &
        \infer[\Rightarrow \mbox{elim with} \lnot p\Rightarrow q]{q}{}
      & \infer[\lor \mbox{elim}]{q}{\ulcorner p \implies q \urcorner^{[1]}}}
    }
    $%
  }
\end{center}
...
\noindent By LEM, we can case-analyze on p $\lor$ $\lnot p$. In both
cases we derive q.
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mbox{elim}]{p}{
      \infer[\lor \mbox{elim}]{p}{\infer[\mbox{false
      elim}]{p}{\infer[\mbox{contradiction with} \lnot \lnot p]{false}{}}}
    }
    $%
  }
\end{center}
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mbox{elim}]{\lnot p \lor \lnot q}{
      \infer[\lor \mbox{elim}]{\lnot p \lor \lnot q}{\infer[\lor
        \mbox{intro left}]{\lnot p \lor \lnot
      q}{\infer[\mbox{identity}]{\lnot p}{}}}
    }
    $%
  }
\end{center}
...
\noindent A proposition is decidable if we can prove p or not p. In
logical notation, we would $write : decidable(p) means$ $p(or)(\lnot p)$.
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mbox{elim}]{p}{
      \infer[\lor \mbox{elim}]{p}{\infer[\mbox{false
      elim}]{p}{\infer[\Rightarrow \mbox{elim}]{false}{}}}
    }
    $%
  }
\end{center}
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\lor \mbox{elim}]{\lnot p \lor q}{
      \infer[\lor \mbox{elim}]{\lnot p \lor q}{\infer[\lor
      \mbox{intro left}]{\lnot p \lor q}{}}
    }
    $%
  }
\end{center}
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{p \implies q}{
      \infer[\mbox{assumption}]{p}{\infer[\mbox{false
        elim}]{q}{\infer[\mbox{contradiction}]{false}{}} &
        \infer[\mbox{identity}]{q}{} & \infer[\lor
      \mbox{elim}]{q}{\ulcorner \lnot p \lor q \urcorner^{[1]}}}
    }
    $%
  }
\end{center}
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    $\displaystyle
    \infer[\lor \mbox{elim}]{p}{
      \infer[\lor \mbox{elim}]{p}{\infer[\Rightarrow \mbox{elim with
        premise}]{p}{\infer[\Rightarrow\textrm{-intro}^{[2]}]{p
          \implies q}{\infer[\mbox{false
...
\noindent 6. [case] $\lnot p$ contradicts $\lnot$ $\lnot p$, derive p
by false elim
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    $\displaystyle
    \infer[\lor \mbox{elim}]{\exists x @ x(drinks) \implies (\forall
    y @ y(drinks))}{
      \infer[\lor \mbox{elim}]{\exists x @ x(drinks) \implies
      (\forall y @ y(drinks))}{\infer[\exists \mbox{intro with
        x}=a]{\exists x @ x(drinks) \implies (\forall y @
        y(drinks))}{\infer[\Rightarrow \mbox{intro}, \mbox{trivially
          true}]{a(drinks) \implies (\forall y @
          y(drinks))}{\infer[\mbox{from p}]{\forall y @
            y(drinks)}{\infer[\mbox{from
              p}]{a(drinks)}{\infer{Pick(any)(person)}{
                  a
        }}}}} & \infer[\exists \mbox{intro with x}=b]{\exists x @
          x(drinks) \implies (\forall y @
        y(drinks))}{\infer[\Rightarrow\textrm{-intro}^{[2]}]{b(drinks)
            \implies (\forall y @
          y(drinks))}{\infer[\mbox{assumption}]{b(drinks)}{\infer[\exists
              \mbox{elim}]{\lnot (b(drinks))}{\infer[\mbox{negation of}
