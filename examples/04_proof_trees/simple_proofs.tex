...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    $\displaystyle
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{p(and(p \implies q))
    \implies p(and)(q)}{
      \infer[\land \mbox{intro}]{p(and)(q)}{\infer[\Rightarrow
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    $\displaystyle
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{((p \implies
    q))(and)(not)(q) \implies not(p)}{
      \infer[negation\textrm{-intro}^{[2]}]{not(p)}{\infer[\land\textrm{-elim-1}]{p
        \implies q}{\ulcorner ((p \implies q))(and)(not)(q)
        \urcorner^{[1]}} &
        \infer[\land\textrm{-elim-2}]{not(q)}{\ulcorner ((p \implies
        q))(and)(not)(q) \urcorner^{[1]}} &
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    not(p)(or)(q)}{
      \infer[\mbox{excluded middle}]{p(or)(not)(p)}{\ulcorner p
      \implies q \urcorner^{[1]}} &
      \infer[\lor\textrm{-elim}^{[2]}]{not(p)(or)(q)}{\infer[\lor\textrm{-intro-2}]{not(p)(or)(q)}{\infer[\Rightarrow
        \mbox{elim}]{q}{\ulcorner p \urcorner^{[2]}}} &
        \infer[\lor\textrm{-intro-1}]{not(p)(or)(q)}{\ulcorner not(p)
      \urcorner^{[2]}}}
    }
    $%
  }
