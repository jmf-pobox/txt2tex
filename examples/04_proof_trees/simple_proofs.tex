...
\implies (p \land q)}{
  \infer[\land \mathrm{intro}]{p \land q}{\infer[\Rightarrow
    \mathrm{elim}]{q}{\infer[\land\textrm{-elim-1}]{p}{\ulcorner p
      \land (p \implies q) \urcorner^{[1]}} &
      \infer[\land\textrm{-elim-2}]{p \implies q}{\ulcorner p \land (p
...
\noindent
$\displaystyle
\infer[\Rightarrow\textrm{-intro}^{[1]}]{p \land (q \lor r) \implies
(p \land q) \lor (p \land r)}{
  \infer[\lor \mathrm{elim}]{(p \land q) \lor (p \land
  r)}{\infer[\lor\textrm{-intro-1}]{(p \land q) \lor (p \land
    r)}{\infer[\land \mathrm{intro}]{p \land q}{\infer[\mathrm{from}
    \mathrm{case}]{q}{\infer[\mathrm{from} above]{p}{}}}} &
    \infer[\lor\textrm{-intro-2}]{(p \land q) \lor (p \land
    r)}{\infer[\land \mathrm{intro}]{p \land r}{\infer[\mathrm{from}
  \mathrm{case}]{r}{\infer[\mathrm{from} above]{p}{}}}}}
}
$
...
\noindent
$\displaystyle
\infer[\Rightarrow\textrm{-intro}^{[1]}]{(p \implies q) \land \lnot q
\implies \lnot p}{
  ...
  p}{\infer[\land\textrm{-elim-1}]{p \implies q}{\ulcorner (p
    ...
    \infer[\mathrm{contradiction}]{false}{\infer[\Rightarrow
  \mathrm{elim}]{q}{\ulcorner p \urcorner^{[2]}}}}
}
$
...
(\lnot p \lor q)}{
  \infer[\mathrm{excluded} \mathrm{middle}]{p \lor \lnot p}{\ulcorner
  p \implies q \urcorner^{[1]}} &
  \infer[\lor\textrm{-elim}^{[2]}]{\lnot p \lor
  q}{\infer[\lor\textrm{-intro-2}]{\lnot p \lor q}{\infer[\Rightarrow
    \mathrm{elim}]{q}{\ulcorner p \urcorner^{[2]}}} &
    \infer[\lor\textrm{-intro-1}]{\lnot p \lor q}{\ulcorner \lnot p
  \urcorner^{[2]}}}
}
$
