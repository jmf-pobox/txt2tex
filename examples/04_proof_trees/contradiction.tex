...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \lnot q)) \implies p}{
      \infer[\mathrm{false
      elim}]{p}{\infer[\mathrm{contradiction}]{false}{\infer[\land\textrm{-elim-2}]{\lnot
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{(p \land \lnot p) \implies q}{
      \infer[\mathrm{false
      elim}]{q}{\infer[\mathrm{contradiction}]{false}{\infer[\land\textrm{-elim-2}]{\lnot
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \lnot \lnot \lnot p}{
      ...
      p}{\infer[\mathrm{false
        elim}]{p}{\infer[\mathrm{contradiction}]{false}{\ulcorner \lnot
      p \urcorner^{[2]}}}}
    }
    $%
  }
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \land (\exists x @ \lnot \power x)) \implies false}{
      \infer[\mathrm{contradiction}]{false}{\infer[\forall
        \mathrm{elim}]{\power a}{\infer[\exists \mathrm{elim},
          \mathrm{fresh a}]{\lnot \power
          a}{\infer[\land\textrm{-elim-2}]{\exists x @ \lnot \power
            x}{\infer[\land\textrm{-elim-1}]{\forall x @ \power
              x}{\ulcorner (\forall x @ \power x) \land (\exists x @ \lnot
      \power x) \urcorner^{[1]}}}}}}
    }
    $%
  }
  ...
  \adjustbox{max width=\textwidth}{%
    ...
    (f(x) = f(y))) \implies x = y}{
      ...
      y}{\infer[\mathrm{contradiction with
        f}(x)=f(y)]{false}{\infer[\mathrm{injective property}]{f(x)
      \neq f(y)}{\ulcorner x \neq y \urcorner^{[2]}}}}
    }
    $%
  }
