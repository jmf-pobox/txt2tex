...
p$ leads to false, then $\lnot$ not p holds.
...
\noindent Reductio ad absurdum: if assuming not p leads to absurdity,
then p holds.
...
\noindent 6. $Remember : contradiction$ is a classical technique (not
constructive)
