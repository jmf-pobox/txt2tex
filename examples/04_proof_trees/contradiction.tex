...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \lnot q)) \implies p}{
      \infer[\mathrm{false}
      \mathrm{elim}]{p}{\infer[\mathrm{contradiction}]{false}{\infer[\land\textrm{-elim-2}]{\lnot
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{(p \land \lnot p) \implies q}{
      \infer[\mathrm{false}
      \mathrm{elim}]{q}{\infer[\mathrm{contradiction}]{false}{\infer[\land\textrm{-elim-2}]{\lnot
...
\noindent Prove that p and $\lnot p$ leads to a contradiction.
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{p \land \lnot p \implies false}{
      \infer[\mathrm{contradiction}]{false}{\ulcorner p \land \lnot p
      \urcorner^{[1]}}
    }
    $%
  }
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \implies \lnot \lnot p}{
      ...
      p}{\infer[\mathrm{assumption}]{\lnot p}{\infer[\Rightarrow
      \mathrm{elim}]{false}{}}}
    }
    $%
  }
...
p$ leads to false, then not $\lnot p$ holds.
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \lnot q) \implies \lnot p}{
      ...
      p}{\infer[\mathrm{assumption}]{p}{\infer[\Rightarrow
...
\noindent $Prove : not$ $\lnot p \implies p(requires(classical)(logic))$
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \lnot \lnot \lnot p}{
      ...
      p}{\infer[\mathrm{false}
        \mathrm{elim}]{p}{\infer[\mathrm{contradiction}]{false}{\ulcorner
      \lnot p \urcorner^{[2]}}}}
    }
    $%
  }
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \land \lnot q)) \implies \lnot \lnot p}{
      ...
      \mathrm{elim}]{q \land \lnot q}{\ulcorner \lnot p \urcorner^{[2]}}}}}}}
    }
    $%
  }
\end{center}
...
\noindent Prove: ($\forall x @ \power x$) and $\exists x @ \lnot
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \land (\exists x @ \lnot \power x)) \implies false}{
      \infer[\mathrm{contradiction}]{false}{\infer[forall
        \mathrm{elim}]{\power a}{\infer[exists \mathrm{elim},fresh
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    $\displaystyle
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{(injective(f) \land f(x)
    = f(y)) \implies x = y}{
      \infer[\lnot\textrm{-intro}^{[2]}]{x =
      y}{\infer[\mathrm{contradiction} with
        f(x)=f(y)]{false}{\infer[injective property]{f(x) \neq
      f(y)}{\ulcorner x \neq y \urcorner^{[2]}}}}
    }
    $%
  }
...
\noindent $Prove : p$ or q, $\lnot p$, $\lnot q \implies false$
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    p \land \lnot q) \implies false}{
      \infer[\lor \mathrm{elim} \mathrm{from} p \lor
      q]{false}{\infer[\mathrm{contradiction} with \lnot p]{false}{}
      & \infer[\mathrm{contradiction} with \lnot q]{false}{}}
    }
    $%
  }
\end{center}
