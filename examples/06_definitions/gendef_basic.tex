...
\noindent This defines identityGB polymorphically. It can be used
with any type: identityGB applied to a natural number returns that
number, identityGB applied to a set returns that set, etc.
...
beyond basic gendef blocks, as free types in Z are typically defined
for specific types rather than being polymorphic.
...
\noindent Here identityGB[N] is the identityGB function instantiated
for natural numbers, and identityGB[P N] is instantiated for sets of
natural numbers.
