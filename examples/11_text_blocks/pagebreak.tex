...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    ...
    \implies q}{
      \infer[\Rightarrow
      \mathrm{elim}]{q}{\infer[\land\textrm{-elim-1}]{p}{\ulcorner p
...
\begin{center}
  \adjustbox{max width=\textwidth}{%
    $\displaystyle
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{(p \lor q) \land \lnot q
    \implies p}{
      \infer[\lor
      \mathrm{elim}]{p}{\infer[\land\textrm{-elim-2}]{\lnot
        q}{\infer[\land\textrm{-elim-1}]{p \lor q}{\ulcorner (p \lor q)
