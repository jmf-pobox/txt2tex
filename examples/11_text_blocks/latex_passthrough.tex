...
\section*{Example 4 : Boxes land Frames}
\addcontentsline{toc}{section}{Example 4 : Boxes land Frames}
...
\begin{center}
  ...
  \fbox{\parbox{0.8\textwidth}{
      ...
      This text appears in a framed box. You can use this to
      highlight important definitions or theorems.
...
\section*{Example 6 : Theorems land Definitions}
\addcontentsline{toc}{section}{Example 6 : Theorems land Definitions}
...
\noindent The clearpage command forces a page break and flushes all
pending floats.

\bigskip

\section*{Example 8 : Mixed Z Notation land LaTeX}
\addcontentsline{toc}{section}{Example 8 : Mixed Z Notation land LaTeX}
...
\noindent This demonstrates the flexibility of mixing txt2tex
notation with raw LaTeX.
...
\noindent The LATEX directive is your escape hatch for any LaTeX
feature not directly supported by txt2tex.
