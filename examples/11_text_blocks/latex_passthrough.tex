...
\addcontentsline{toc}{section}{LATEX Passthrough Examples}

\subsection*{Example 1 : Basic LaTeX Commands}
\addcontentsline{toc}{subsection}{Example 1 : Basic LaTeX Commands}
...
\subsection*{Example 2 : Custom Spacing}
\addcontentsline{toc}{subsection}{Example 2 : Custom Spacing}
...
\subsection*{Example 3 : Custom Formatting}
\addcontentsline{toc}{subsection}{Example 3 : Custom Formatting}
...
\subsection*{Example 4 : Boxes land Frames}
\addcontentsline{toc}{subsection}{Example 4 : Boxes land Frames}
...
\subsection*{Example 5 : Custom Lists}
\addcontentsline{toc}{subsection}{Example 5 : Custom Lists}
...
\subsection*{Example 6 : Theorems land Definitions}
\addcontentsline{toc}{subsection}{Example 6 : Theorems land Definitions}
...
\subsection*{Example 7 : Page Layout Control}
\addcontentsline{toc}{subsection}{Example 7 : Page Layout Control}
...
\subsection*{Example 8 : Mixed Z Notation land LaTeX}
\addcontentsline{toc}{subsection}{Example 8 : Mixed Z Notation land LaTeX}
...
\subsection*{Example 9 : Custom Macros}
\addcontentsline{toc}{subsection}{Example 9 : Custom Macros}
