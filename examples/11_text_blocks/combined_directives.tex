...
\addcontentsline{toc}{section}{Combined Text Directives}

\subsection*{Example 1 : Documentation Style}
\addcontentsline{toc}{subsection}{Example 1 : Documentation Style}
...
\subsection*{Example 2 : Tutorial Format}
\addcontentsline{toc}{subsection}{Example 2 : Tutorial Format}
...
\subsection*{Example 3 : Showing Syntax vs Using Syntax}
\addcontentsline{toc}{subsection}{Example 3 : Showing Syntax vs Using Syntax}
...
\subsection*{Example 4 : Code Examples with Explanations}
\addcontentsline{toc}{subsection}{Example 4 : Code Examples with Explanations}
...
\subsection*{Example 5 : Mathematical Explanation}
\addcontentsline{toc}{subsection}{Example 5 : Mathematical Explanation}
...
\subsection*{Example 6 : Syntax Reference}
\addcontentsline{toc}{subsection}{Example 6 : Syntax Reference}
...
\subsection*{Example 7 : Best Practices}
\addcontentsline{toc}{subsection}{Example 7 : Best Practices}
...
\subsection*{Example 8 : Real - World Document Structure}
\addcontentsline{toc}{subsection}{Example 8 : Real - World Document Structure}
...
\addcontentsline{toc}{section}{Section 2: Data Types}
...
\addcontentsline{toc}{section}{Section 3: State Schema}
...
\addcontentsline{toc}{section}{Section 4: Operations}
