...
\section*{Subscripts land Superscripts}
...
\section*{Example 6 : Exponentiation elem Expressions}
\addcontentsline{toc}{section}{Example 6 : Exponentiation elem Expressions}
...
\section*{Example 9 : Combined Subscripts land Superscripts}
\addcontentsline{toc}{section}{Example 9 : Combined Subscripts land Superscripts}
...
\noindent
$x \bsup 2 \esup \bsup 3 \esup = x \bsup 6 \esup$
...
\section*{Example 16 : Exponents elem Constraints}
\addcontentsline{toc}{section}{Example 16 : Exponents elem Constraints}
...
\noindent While txt2tex doesn't have built-in summation, subscripts help express it:
...
\noindent For a geometric sequence with first term a\_0 and ratio $r : a_0$, a\_0 * r, a\_0 * r * r, a\_0 * r * r * r, ...
...
\noindent 1. Use subscripts for indices, versions, or families (x\_1, x\_i, S\_k)
...
\noindent 3. Parenthesize complex expressions: (x+1)^2, not x+$1^2$
