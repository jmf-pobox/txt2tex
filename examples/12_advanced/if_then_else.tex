...
\begin{axdef}
  ...
  \where
  \forall x : \num @ \\
  \t1 piecewise(x) = \IF x < -5 \THEN 0 \ELSE \IF x < 0 \THEN x + 5
...
\begin{axdef}
  ...
  \where
  \forall income : \nat @ \\
  \t1 taxRate(income) = \IF income < 20000 \THEN 10 \ELSE \IF income
  < 50000 \THEN 15 \ELSE \IF income < 100000 \THEN 20 \ELSE 25
\end{axdef}
...
\begin{axdef}
  ...
  \where
  \forall n : \nat @ \\
  \t1 complexFunc(n) = \IF n \mod 3 = 0 \THEN n * n \ELSE \IF n \mod
  3 = 1 \THEN n + 10 \ELSE n * 2
\end{axdef}
