...
$\displaystyle
\begin{array}{l}
\mathrm{Project}\{winner, venue, tier\}(Tournament \otimes \\
\quad \mathrm{Rename}_{tournament \to tournamentId}(\mathrm{Project}\{tournament\}(\mathrm{Restrict}_{winner = `Ali'}(Match))))
\end{array}$
