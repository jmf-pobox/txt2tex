...
$\displaystyle
\begin{array}{l}
\mathrm{Project}_{winner, venue, tier}(Tournament \otimes \\
\quad \mathrm{Rename}_{tournament \to tournamentId}(\mathrm{Project}_{tournament}(\mathrm{Restrict}_{winner = `Ali'}(Match))))
\end{array}$
