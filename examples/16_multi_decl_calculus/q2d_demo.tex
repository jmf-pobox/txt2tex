...
\noindent This is the canonical DAT relational-calculus form for any query that crosses two or more relations. Before the fix it required a raw LATEX block; now it parses natively.
