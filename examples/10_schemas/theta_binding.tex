...
\addcontentsline{toc}{section}{theta-Expression}
...
\noindent The Xi-style frame condition $\theta S = \theta S'$ asserts that none of the schema components changed.  This is the definition of Xi S expressed using theta directly.
