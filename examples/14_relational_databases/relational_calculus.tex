...
\t1 al.arid = ar.arid @ \\ \lblot~track == t.title, artist == ar.name~\rblot  ~\}\end{array}
\end{array}$
...
\t1 t.alid = al.alid @ \\ \lblot~playlist == p, track == t.title, album == al.title~\rblot  ~\}\end{array}
\end{array}$
...
\t1 t.duration > 300 @ \\ \lblot~track == t.title, album == al.title~\rblot  ~\}\end{array}
\end{array}$
