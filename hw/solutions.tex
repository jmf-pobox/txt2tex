...
\infer[$\Rightarrow$\text{-intro}^{[1]}]{(p \Rightarrow r) \land (q \Rightarrow r) \Rightarrow (p \lor q \Rightarrow r)}{
  ...
  \ulcorner p \lor q \urcorner^{[2]} & \infer[\text{$\lor$ elim}]{r}{
  \infer[$\land$\text{-elim-1}]{p \Rightarrow r}{
  \ulcorner (p \Rightarrow r) \land (q \Rightarrow r) \urcorner^{[1]}
} & \infer[\text{$\Rightarrow$ elim}]{r}{
  p \Rightarrow r & \ulcorner p \urcorner
}
  \infer[$\land$\text{-elim-2}]{q \Rightarrow r}{
  \ulcorner (p \Rightarrow r) \land (q \Rightarrow r) \urcorner^{[1]}
} & \infer[\text{$\Rightarrow$ elim}]{r}{
  q \Rightarrow r & \ulcorner q \urcorner
}
}
}
}
