...
\begin{zed}PlayedOrNot ::= P | NotP\end{zed}

\begin{zed}SavedOrNot ::= S | NotS\end{zed}
...
\forall s : ShowId @ \forall e : EpisodeId @ (s, e) \in \ran my\_episodes \implies ((s, e) \in \dom status \land \\
