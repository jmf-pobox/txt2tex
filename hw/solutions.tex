  ...
  \adjustbox{max width=\textwidth}{%
    ...
    \infer[\Rightarrow\textrm{-intro}^{[1]}]{p \implies (\lnot p \implies p)}{
      ...
      p}{\ulcorner p \urcorner^{[1]} &
        ...
        p}{\infer[\mathrm{false} - \mathrm{intro}]{false}{\ulcorner
      \lnot p \urcorner^{[2]} & \ulcorner p \urcorner^{[3]}}}}
    }
    $%
  }
\end{center}
...
\noindent\hspace*{\parindent}(c) To use proof by induction, we need
to prove the base case and the inductive case.
