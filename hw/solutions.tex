...
\begin{axdef}
  ...
  \where
  SquareCubePairsOfEvens = \{ z_1, z_2 : \num | z\_1 \mod 2 = 0 \land
  z\_2 \mod 2 = 0 @ (z\_1 * z\_1, z\_2 * z\_2 * z\_2) \}
\end{axdef}
...
\begin{axdef}
  ...
  e_2 : EpisodeId @ \\
  \quad ((s, e\_1) \in \dom episode\_info \land (s, e\_2) \in \dom
  episode\_info) \land \\
  \quad ((e\_1 < e\_2) \implies (snd(episode\_info(s, e\_1)) \leq
  snd(episode\_info(s, e\_2))))
\end{axdef}
...
\begin{zed}
  ...
  s\_1 \neq s\_2 \land p \in show\_info(s\_1) \land p \in show\_info(s\_2) \}
\end{zed}
...
\noindent
\hangindent=2em
(c) $\forall l : List @ length\_L(played\_L(l)) +
...
\[
  \begin{array}{ll@{\hspace{2em}}l}
    ...
    &\Leftrightarrow length\_L(nil) & [\mbox{length(nil)=0}]
  \end{array}
\]
