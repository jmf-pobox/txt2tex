...
\forall s : ShowId @ \forall e : EpisodeId @ (s \in \dom show\_episodes \land e \in show\_episodes(s) \implies (s, e) \in \dom episode\_info) \land \\
\quad ((s, e) \in \dom episode\_info \implies s \in \dom show\_episodes \land e \in show\_episodes(s)) \\
\forall s : ShowId @ \forall e : EpisodeId @ s \in \dom show\_episodes \land e \in show\_episodes(s) \Leftrightarrow (s, e) \in \dom episode\_info \\
shows \subseteq \dom show\_info \land \dom show\_info \subseteq shows \\
\forall s : ShowId @ \forall p : PeopleId @ \exists e : EpisodeId @ (s, e) \in \dom episode\_info \land p \in fst(episode\_info(s, e)) \implies \\
