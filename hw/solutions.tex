...
\where
  \forall ss \colon \seq_1 (\seq X) \bullet maxSeq(ss) \in \ran ss \land \forall t \colon \seq X \bullet t \in \ran ss \Rightarrow \# maxSeq(ss) \geq \# t
\end{gendef}

\begin{gendef}[X]
  minSeq: \seq_1 (\seq X) \fun \seq X
\where
  \forall ss \colon \seq_1 (\seq X) \bullet minSeq(ss) \in \ran ss \land \forall t \colon \seq X \bullet t \in \ran ss \Rightarrow \# minSeq(ss) \leq \# t
\end{gendef}
...
Naturals : \mathbb{N}
\where
\forall x \colon \mathbb{N} \bullet x \geq 0
\end{axdef}

\begin{axdef}
NaturalsExist : \mathbb{N}
\where
\exists x \colon \mathbb{N} \bullet x > 100
\end{axdef}

\begin{axdef}
NaturalsExistOne : \mathbb{N}
\where
\exists_1 x \colon \mathbb{N} \bullet x = 100
\end{axdef}

\begin{axdef}
BadMu : \mathbb{N}
\where
BadMu = \mu n \colon \mathbb{N} \bullet n > 0
\end{axdef}

\begin{gendef}[X, Y]
  fst: X \cross Y \fun X
\where
  \forall x \colon X \bullet \forall y \colon Y \bullet fst(x, y) = x
\end{gendef}
