...
\begin{zed}List ::= nil | join \ldata ((ShowId \cross EpisodeId)
  \cross ((\nat \cross PlayedOrNot) \cross SavedOrNot)) \cross List \rdata
\end{zed}
...
A suitable induction principle would be
...
\infer{\forall l : List @ \power l}{
  \power nil
  &
  \forall n : \nat @ \forall l : List @ \power l \implies \power (join(n, l))
}
$
