...
\[
  \begin{array}{ll@{\hspace{2em}}l}
    ...
    &\Leftrightarrow length(\langle \rangle) & [\mbox{length (
    $\langle \rangle$ ) = 0}]
  \end{array}
\]
...
\quad length(played(ple^t)) + length(unplayed(ple^t)) = length(ple^t)$

\[
  \begin{array}{ll@{\hspace{2em}}l}
    & length(played(ple^t)) + length(unplayed(ple^t)) \\
    &\Leftrightarrow snd(ple) + length(t) \\
    &\Leftrightarrow length(ple^t) & [\mbox{length ( $\langle  ple
