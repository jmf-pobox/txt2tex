...
An example for such a list could be (List((1, 2), (3600, NotP,
...
I will also define some convenience functions to enable
fuzz-compliant access to elements of the triple (N cross PlayedOrNot
cross SavedOrNot)
...
Now can now define simply the induction principle for this list
\citep[page 161]{simpson-notes}.
