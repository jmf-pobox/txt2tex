...
This needs to be simplified by using dom(function) to declare the types.
...
\forall s : ShowId @ \forall e : EpisodeId @ s \in \dom show\_episodes \land \\
\quad e \in show\_episodes(s) \iff \\
\quad (s, e) \in \dom episode\_info \\
...
\quad (p \in fst(episode\_info(s, e)) \iff \\
\quad p \in show\_info(s)) \\
\forall s : ShowId @ \forall t_1, t_2 : Timestamp @ \forall e_1, e_2 : EpisodeId @ \\
\quad (s, e_1) \in \dom episode\_info \land (s, e_2) \in \dom episode\_info \land (e_1 < e_2 \implies snd(episode\_info(s, e_1)) \leq snd(episode\_info(s, e_2)))
\end{schema}
...
\noindent
\hangindent=2em
(c) $\forall s : ShowId @ \forall e : EpisodeId @ s \in \dom show\_episodes \land \\
\quad e \in show\_episodes(s) \iff \\
\quad (s, e) \in \dom episode\_info$
...
\noindent
\hangindent=2em
(e) $\forall s : ShowId @ \forall p : PeopleId @ \exists e : EpisodeId @ (s, e) \in \dom episode\_info \land \\
\quad p \in fst(episode\_info(s, e)) \iff \\
\quad p \in show\_info(s)$
...
\noindent
\hangindent=2em
(f) $\forall s : ShowId @ \forall t_1, t_2 : Timestamp @ \forall e_1, e_2 : EpisodeId @ (s, e_1) \in \dom episode\_info \land \\
\quad (s, e_2) \in \dom episode\_info \land (e_1 < e_2 \implies snd(episode\_info(s, e_1)) \leq snd(episode\_info(s, e_2)))$
