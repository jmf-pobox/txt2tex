...
$p \Rightarrow (\lnot p \Rightarrow p)$ is a tautology as it is true for every interpretation as illustrated by the final column of truth values.
...
$\lnot p \Rightarrow \lnot q \Leftrightarrow q \Rightarrow p$ is a tautology as it is true for every interpretation of its constituent parts as illustrated by the final column of truth values.
...
(($p \Rightarrow r$) and ($q \Rightarrow r$)) $\Leftrightarrow$ ((p or q) $\Rightarrow$ r) is a tautology as it is true for every interpretation of its constituent parts as illustrated by the final column of truth values.
...
In this equivalence proof, we show that $p \Rightarrow (\lnot p \Rightarrow p)$ by using implication disjunction, the definition of double negation, the application of the idempotence rule and the definition of true.
...
In this equivalance proof, we show that $\lnot p \Rightarrow \lnot q \Leftrightarrow q \Rightarrow p$ by using implication disjunction, the distributivity 2 rule, and the associativity of logical or. 
