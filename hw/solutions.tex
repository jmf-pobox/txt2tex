...
\noindent
$\displaystyle
\infer[$\Rightarrow$\mbox{-intro}^{[1]}]{(\lnot p \Rightarrow \lnot q) \Rightarrow (q \Rightarrow p)}{
  \ulcorner \lnot p \Rightarrow \lnot q \urcorner^{[1]} & \infer[$\Rightarrow$\mbox{-intro}^{[2]}]{q \Rightarrow p}{
  \ulcorner q \urcorner^{[2]} & \infer[false\mbox{-elim}^{[3]}]{p}{
  \infer[\mbox{false intro}]{false}{
  \infer[\mbox{$\Rightarrow$ elim}]{\lnot q}{
...
\noindent
$\displaystyle
\infer[$\Rightarrow$\mbox{-intro}^{[1]}]{(q \Rightarrow p) \Rightarrow (\lnot p \Rightarrow \lnot q)}{
  \ulcorner q \Rightarrow p \urcorner^{[1]} & \infer[$\Rightarrow$\mbox{-intro}^{[2]}]{\lnot p \Rightarrow \lnot q}{
  \ulcorner \lnot p \urcorner^{[2]} & \infer[false\mbox{-elim}^{[3]}]{\lnot q}{
  \infer[\mbox{false intro}]{false}{
  \infer[\mbox{$\Rightarrow$ elim}]{p}{
...
\noindent
$\displaystyle
\infer[\mbox{$\Leftrightarrow$ intro}]{\lnot p \Rightarrow \lnot q \Leftrightarrow q \Rightarrow p}{
...
\noindent
$\displaystyle
\infer[$\Rightarrow$\mbox{-intro}^{[1]}]{(p \Rightarrow r) \land (q \Rightarrow r) \Rightarrow (p \lor q \Rightarrow r)}{
  \ulcorner (p \Rightarrow r) \land (q \Rightarrow r) \urcorner^{[1]} & \infer[$\Rightarrow$\mbox{-intro}^{[2]}]{p \lor q \Rightarrow r}{
  \ulcorner p \lor q \urcorner^{[2]} & \infer[$\lor$\mbox{-elim}^{[3]}]{r}{
  \raiseproof{10ex}{\infer[$\land$\mbox{-elim-1}]{p \Rightarrow r}{
  \ulcorner (p \Rightarrow r) \land (q \Rightarrow r) \urcorner^{[1]}
} & \infer[\mbox{$\Rightarrow$ elim}]{r}{
  p \Rightarrow r & \ulcorner p \urcorner^{[3]}
}} & \hskip 6em \raiseproof{26ex}{\infer[$\land$\mbox{-elim-2}]{q \Rightarrow r}{
  \ulcorner (p \Rightarrow r) \land (q \Rightarrow r) \urcorner^{[1]}
} & \infer[\mbox{$\Rightarrow$ elim}]{r}{
