...
\begin{tabularx}{\columnwidth}{LR}
sigma[p](R)          & $\sigma_{p}(R)$ — restrict \\
pi[A,B](R)           & $\pi_{A,B}(R)$ — project \\
rho[A as B](R)       & $\rho_{A \to B}(R)$ — rename \\
R bowtie S           & $R \bowtie S$ — natural join \\
R bowtie [p] S       & $R \bowtie_{p} S$ — theta-join \\
