...
\begin{center}
{\LARGE\bfseries txt2tex DAT Reference}\\[2pt]
{\small Database Design: primary keys, relational algebra, bindings, GROUP/UNGROUP.}\\[1pt]
...
\begin{center}
{\LARGE\bfseries txt2tex DAT --- By Example}\\[2pt]
{\small Database Design: primary keys, relational algebra, bindings, GROUP/UNGROUP.}
\end{center}
...
\smallskip
{\scriptsize\textbf{Naming a query.} Use \texttt{Name == expr} for any right-hand side — pure Z or DAT algebra.}
