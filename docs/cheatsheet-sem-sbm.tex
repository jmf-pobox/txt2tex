...
\begin{center}
{\LARGE\bfseries txt2tex SEM/SBM Reference}\\[2pt]
{\small Software Engineering Mathematics \& State-Based Modelling: logic, sets, sequences, proofs, Z schemas, operations, \(\Delta\)/\(\Xi\), schema calculus.}\\[1pt]
