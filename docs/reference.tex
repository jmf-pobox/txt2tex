...
%% ── PAGE 4: SEQUENCES + Z PARAGRAPHS + SCHEMAS PART 1 ──
\newpage
...
%% ── PAGE 5: SCHEMAS PART 2 + SCHEMA OPERATIONS ──
\newpage
...
%% ── PAGE 6: Z BINDINGS + PROOFS PART 1 ──────────
\newpage
...
{\scriptsize Trees are written \textbf{bottom-up}: conclusion first, premises indented below.}
