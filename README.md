...
**[Quick Reference (PDF)](docs/cheatsheet.pdf)** — two-page reference card with every operator, block type, and proof syntax, plus side-by-side examples showing what you type and what txt2tex renders.
